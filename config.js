...
=======
  "bundles": {
    "app-build": [
      ...
      "blur-image",
      "home",
      "home.html!github:systemjs/plugin-text@0.0.3",
      "login",
      "login-status",
      "login.html!github:systemjs/plugin-text@0.0.3",
      "logout",
      "logout.html!github:systemjs/plugin-text@0.0.3",
      "main",
      "nav-bar.html!github:systemjs/plugin-text@0.0.3",
      "popular-movies",
      "popular-movies.html!github:systemjs/plugin-text@0.0.3",
      "whoami",
      "whoami.html!github:systemjs/plugin-text@0.0.3"
    ],
    "aurelia-2508de3771": [
...
>>>>>>> 7ac16d9db1c47bb0ba583a92dd411380f0ac5adf
    ]
  }
})
